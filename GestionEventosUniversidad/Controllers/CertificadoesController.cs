...
namespace GestionEventosUniversidad.API.Controllers
{
    ...
    [ApiController]
    public class CertificadoesController : ControllerBase
    {
        private readonly AppDbContext _context;

        public CertificadoesController(AppDbContext context)
        {
            _context = context;
        }

        // GET: api/Certificadoes
        [HttpGet]
        ...
        {
            return _context.Certificado.Any(e => e.CertificadoId == id);
        }
    }
}
